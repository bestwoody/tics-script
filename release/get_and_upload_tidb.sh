...
function get_and_upload_tidb()
{
	...
	local file="tidb-server"
	local z_file="${file}.tar.gz"
	rm -f ${z_file}
	download_release_binary "${download_server}/tidb/${commit}/centos7/${z_file}" "${file}" "./"
