...
public class ColumnarRow extends InternalRow {
    ...
    for (int i = 0; i < numFields(); i++) {
      if (isNullAt(i)) {
        ...
        if (dt instanceof BooleanType) {
          ...
          row.update(i, getUTF8String(i).clone());
  ...
  public boolean isNullAt(int ordinal) {
    return data.getChildColumn(ordinal).isNullAt(rowId);
  }

  @Override
  public boolean getBoolean(int ordinal) {
    return data.getChildColumn(ordinal).getBoolean(rowId);
  }

  @Override
  public byte getByte(int ordinal) {
    return data.getChildColumn(ordinal).getByte(rowId);
  }

  @Override
  public short getShort(int ordinal) {
    return data.getChildColumn(ordinal).getShort(rowId);
  }

  @Override
  public int getInt(int ordinal) {
    return data.getChildColumn(ordinal).getInt(rowId);
  }

  @Override
  public long getLong(int ordinal) {
    return data.getChildColumn(ordinal).getLong(rowId);
  }

  @Override
  public float getFloat(int ordinal) {
    return data.getChildColumn(ordinal).getFloat(rowId);
  }

  @Override
  public double getDouble(int ordinal) {
    return data.getChildColumn(ordinal).getDouble(rowId);
  }
