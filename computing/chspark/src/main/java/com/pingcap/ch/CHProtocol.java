...
public class CHProtocol {
    public static class Server {
        ...
        public static final int Extremes = 8;             /// A block with minimums and maximums (compressed or not).
    ...
    public static class Client {
        ...
        public static final int Query = 1;               /// Query id, query settings, stage up to which the query must be executed,
