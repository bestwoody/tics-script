def runTiDBTest(branch, version, notify) {
  runTiDBTest2(branch, version, "", "", "", "", notify)
}

def runTiDBTest2(branch, version, tidb_commit_hash, tikv_commit_hash, pd_commit_hash, tiflash_commit_hash, notify) {
    ...
    stage('Summary') {
        ...
        def slackmsg = "TiFlash TiDB_Test Integration Test\n" +
                "Result: `${currentBuild.result}`\n" +
                "Branch: `${branch}`\n" +
                "Version: `${version}`\n" +
                "Elapsed Time: `${duration}` Mins\n" +
                "https://internal.pingcap.net/idc-jenkins/blue/organizations/jenkins/tiflash_tidb_test/activity\n" +
                "https://internal.pingcap.net/idc-jenkins/job/tiflash_tidb_test/"
        print slackmsg
